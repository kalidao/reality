---
title: Development
description: Guidelines for working on reality
---
...
[Create a new release](https://github.com/kalidao/reality/releases/new) on GitHub with a tag that follows [semantic versioning](https://semver.org/). Publishing a release triggers a workflow for building, testing, and pushing to [npm](https://www.npmjs.com/package/reality).

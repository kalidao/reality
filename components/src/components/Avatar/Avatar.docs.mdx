...
```tsx live=true
<Stack align="center" direction="horizontal" wrap>
  <Avatar label="Noun 97 circle" shape="circle" size="24" src={avatars.noun97} />
  <Avatar label="Noun 97 square" shape="square" size="24" src={avatars.noun97} />
</Stack>
```
